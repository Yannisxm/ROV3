...
public class RVOSimulator {
	 ...
	 */
	public RVOSimulator(double timeStep, double neighborDist, int maxNeighbors, double timeHorizon, double radius, double maxSpeed, Double3D velocity)
	{
		globalTime_=0.0;
		timeStep_=timeStep;
		ptrkdTree_ = new KdTree(this);
	 ...
	 * \param   velocity      The default initial three-dimensional linear velocity of a new agent (optional).
	 */
	public void setAgentDefaults(double neighborDist, int maxNeighbors, double timeHorizon, double radius, double maxSpeed, Double3D velocity)
	{
	 ...
	 */
	public int addAgent(Double3D position, double neighborDist, int maxNeighbors, double timeHorizon, double radius, double maxSpeed, Double3D velocity)
	{
		Agent agent = new Agent(this);
